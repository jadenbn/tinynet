CXX = clang++
CXXFLAGS = -std=c++20 -Wall -Icommon/include -Icommon -Iclient/include -Iclient/include/game -Iserver/include -Ishared/include 
...
client:
	...
	@mkdir -p client/bin
	$(CXX) $(CXXFLAGS) client/src/*.cpp client/src/game/*.cpp $(COMMON_SRC) $(SHARED_SRC) $(CLIENT_FLAGS) -o client/bin/client
